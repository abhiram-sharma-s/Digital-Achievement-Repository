...
<br>
	...
	<center>
	<a href="export2.php"><button>EXPORT</button></a>
	
	<!--<a href="facupdate.html"><button>UPDATE</button></a>
	
	<a href="facdelete.html"><button>DELETE</button></a>-->
	
	<a href="barchart2.php"><button>GRAPH VIEW</button></a>

	<a href="resultsort2.php"><button>SEARCH</button></a>
